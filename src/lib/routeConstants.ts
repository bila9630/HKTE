...
> = {
  sz: [
    ...
    { id: "SZ-02", plate: "粤B·K9012", battery: 45, status: "charging",   speed: 52, trips: 2, color: "#fb923c" },
  ...
  yantian: [
    ...
    { id: "YT-02", plate: "粤B·F6623", battery: 34, status: "charging",   speed: 58, trips: 2, color: "#06b6d4" },
  ...
  nanshan: [
    ...
    { id: "NS-03", plate: "粤B·N9934", battery: 81, status: "charging",   speed: 51, trips: 3, color: "#f43f5e" },
  ],
};
